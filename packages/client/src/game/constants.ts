// type SubsetOf<T extends readonly string[], U extends readonly string[]> = T[number] extends U[number]
//   ? T
//   : never;

// const set = ["1", "2", "3", "4"] as const;

// // Correct
// const subset1: SubsetOf<typeof subset1, typeof set> = ["1", "2"] as const;
